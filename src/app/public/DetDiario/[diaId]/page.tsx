                        ...
                        {pesdiario?.map((item:any, idx) => {
                            return <button key={idx} >
                                <div className='col-span-1 flex-col items-center justify-center'>
                                    <div>
                                        <span className="text-yellow-400 text-[10px] font-semibold ">{item.dcbColId} - {item.crgDescricao}</span>
                                    </div>
                                    <div>
                    ...
                    <div className="grid grid-cols-4 gap-1 md:grid-cols-4 md:gap-2 w-full h-full">
                        {equdiario?.map((item:any, idx) => {
                            return <button key={idx} >
                                <div className='col-span-1 flex-col items-center justify-center'>
                                    <div>
                                        <span className="text-yellow-400 text-[10px] font-semibold ">{item.deqEquId} - {item.equDescricao}</span>
                                    </div>
                                    <div>
                    ...
                    <div className="grid grid-cols-4 gap-1 md:grid-cols-4 md:gap-2 w-full h-full">
                        {atvdiario?.map((item:any, idx) => {
                            return <button key={idx} >
                                <div className='col-span-1 flex-col items-center justify-center'>
                                    <div>
                                        <span className="text-yellow-400 text-[10px] font-semibold ">{item.dtvAtvId} - {item.atvDescricao}</span>
                                    </div>
                                    <div>
