...
export default function NewAtividade(){
    ...
    async function handleCadastra(e:any){      
        ...
        api({
          ...
          data: {
            ...
            alert(`Atividade cadastrada com sucesso! ${response.data}` )
    ...
    return(
        <div className="flex flex-col w-full h-screen items-center bg-slate-900">
            <div className="flex flex-row w-full h-20 bg-slate-800 items-center justify-between p-2 md:p-20">
            </div>
            <div className="flex flex-col w-full h-auto  items-center p-2 md:p-20">
                <form className="flex flex-col justify-center items-center bg-slate-700 p-12 rounded-lg w-full md:w-4/5 h-full max-w-full gap-2 ">
                    ...
                    <div className="flex flex-row justify-between items-center w-full h-auto gap-2">
                        <input className="w-full border-2 border-black p-3 mb-3 focus:border-blue-700" name="nomObra" placeholder="Informe a Atividade" type="text" value={atvDescricao} onChange={(e) => {setAtvDescricao(e.target.value)}} />
                    </div>
