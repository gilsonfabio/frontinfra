    ...
    return(
        <div className="flex flex-col w-full h-screen items-center bg-slate-900">
            ...
            <div className="flex flex-col w-full h-auto  items-center p-2 md:p-20">
                <form className="flex flex-col justify-center items-center bg-slate-700 rounded-lg w-full md:w-4/5 h-full max-w-full gap-2 ">
                    <h2 className="text-white text-2xl font-bold mb-6 ">Altere dados da Atividade</h2>
